"""
=============================================================================
CHUẨN HÓA DỮ LIỆU NHÃN HUẤN LUYỆN (DATASET PREPARATION MODULE)
- Gộp các lớp tư thế học sinh (0..6) thành lớp 0 (student_head).
- Loại bỏ nhãn giáo viên (lớp 7).
...
DATASET_DIR = PROJECT_ROOT / "dataset" / "classroom_data"
